...
<body>
            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="dropdown-container">
                        <a class="active" href="admin_letas_impound.php"><i class="fa-solid fa-file"></i> Impound Records</a>
    ...
    <main>
        <div class="container">
            ...
            <div class="box">
                <h3>Appraisal Report For Unclaimed Impound Motor Vehicle</h3>
                <div class="wrapper">
                    <div class="content-1">
                        <div class="filter">
                            <form action="" method="">
                    ...
                    <div class="content-2">
                        <form action="" method="post">
                            ...
                            <div class="buttons">
                                ...
                                <button class="add" name="add"><i class="fa-solid fa-plus"></i> Add New</button>
                            </div>
                        </form>
                    </div>
                </div>
