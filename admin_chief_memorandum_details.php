...
<head>
    ...
    <link rel="stylesheet" href="css/admin_chief_memorandum_details.css">
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="box">
                <h3>Details of specific record in Memorandum</h3>
                <div class="contents">
                    <form action="" method="post">
                        <div class="details">
                            ...
                            <div class="head" id="head">
                                <div class="image">
                                    <img src="img/sample_image.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="details" id="hidden-div">
                            <div class="head">
                                <div class="image">
                                    <img src="img/sample_image.jpg" alt="">
                                </div>
