...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="box">
                <h3>Adding Record For Monitoring</h3>
                <div class="contents">
                    <form action="db_misc_monitoring.php" method="post">
                        <div class="mv-details">
                            <div class="details">
                                ...
                                <label for="">ENC :</label>
                                <input type="text" name="enc" placeholder="">
                                <label for="">Moter Vehicle File :</label>
                                <input type="text" id="motor_vehicle_file" name="motor_vehicle_file"  placeholder="">
                            </div>
                            <div class="details">
                                <label for="">Plate Number :</label>
                                <input type="text" name="plate_number" placeholder="">
                                <label for="">Borrower :</label>
                                <input type="text" name="borrower" placeholder="">
                                <label for="">Purpose :</label>
                                <input type="text" name="purpose" placeholder="">
                                <label for="">Returned Date :</label>
                                <input type="date" name="returned_date" placeholder="">
